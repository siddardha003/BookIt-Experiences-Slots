...
export const ExperienceSummarySection = (): JSX.Element => {
  const navigate = useNavigate();
  return (
    <Card className="w-[280px] overflow-hidden rounded-xl border-0 shadow-none">
      <div className="[background:url(..//frame-9-6.png)_50%_50%_/_cover] w-full h-[170px]" />
        ...
        <div className="flex flex-col items-start gap-3 w-full">
          <div className="flex items-center justify-between w-full">
            ...
            <Badge className="bg-[#d5d5d5] hover:bg-[#d5d5d5] text-[#161616] px-2 py-1 rounded h-auto">
              <span className="[font-family:'Inter',Helvetica] font-medium text-[11px] tracking-[0] leading-4">
                Bangalore
              </span>
            </Badge>
          </div>
