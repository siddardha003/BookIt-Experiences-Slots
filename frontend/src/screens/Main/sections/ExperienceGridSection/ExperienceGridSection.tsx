...
export const ExperienceGridSection = (): JSX.Element => {
  const navigate = useNavigate();
  return (
    <Card className="flex flex-col w-[280px] rounded-xl overflow-hidden">
      <div className="[background:url(..//frame-9-2.png)_50%_50%_/_cover] w-full h-[170px]" />
      ...
      <CardContent className="flex flex-col items-start gap-5 p-4 bg-[#f0f0f0]">
        <div className="flex flex-col items-start gap-3 w-full">
          <div className="flex items-center justify-between w-full">
            ...
            <Badge className="bg-[#d5d5d5] text-[#161616] hover:bg-[#d5d5d5] h-auto px-2 py-1 rounded">
              <span className="font-medium text-[11px] [font-family:'Inter',Helvetica] tracking-[0] leading-4">
                Manali
              </span>
            </Badge>
          </div>
        ...
        <div className="flex items-center justify-between w-full">
          ...
          <Button
            ...
            className="bg-[#ffd643] hover:bg-[#ffd643]/90 text-[#161616] h-auto px-2 py-1.5 rounded"
          >
            <span className="[font-family:'Inter',Helvetica] font-medium text-sm tracking-[0] leading-[18px]">
              View Details
            </span>
          </Button>
        </div>
